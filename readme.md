# Infrared and visible light fireworks person recognition dataset

# Body

Infrared and visible light dual-modality firework recognition dataset - 182-infrared and visible light dual-modality firework recognition dataset
3 categories: smoke, fire, person

The dataset contains 11220 images of visible light and 11220 images of infrared. The labels have been marked. The visible light and infrared are matched one to one.
Note: The images are extracted from video frames
Blue Circle] Gift best.pt [Blue Circle
